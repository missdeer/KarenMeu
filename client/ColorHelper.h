...
public:
     ...
     */
    static QColor applyAlpha(const QColor &foreground, const QColor &background);
     ...
     */
    static QColor applyAlpha(const QColor &foreground, const QColor &background, int alpha);
     ...
     */
    static QColor lightenToMatchContrastRatio(const QColor &foreground, const QColor &background, double contrastRatio);
...
private:
     ...
     */
    static inline int applyAlphaToChannel(const int foreground, const int background, const qreal alpha)
    {
